  ...
  <div class="onboarding-widget">
    ...
    <div class="widget-header">
      ...
      <div class="widget-actions">
        ...
        <button @click="showModal = true" class="add-btn" title="Start Onboarding">
    ...
    <div class="widget-content">
      <div class="coming-soon-container">
        ...
        <p>Manage new hire onboarding process</p>
    ...
    <div v-if="showModal" class="modal-overlay" @click="closeModal">
      <div class="modal-container" @click.stop>
        <div class="modal-header">
          <h2>Start Onboarding Process</h2>
        ...
        <div class="modal-body">
          <p>Onboarding process setup will be implemented soon.</p>
        </div>
      </div>
    </div>
  </div>
